...
**AI能力说明：**
AI编标产品涉及AI能力的核心环节均调用三方工作流（扣子/Coze平台）实现，主要包括：
- **招标文件解析**：调用工作流自动提取招标文件中的项目信息、招标要求、评分标准等关键内容
- **目录生成**：调用工作流根据招标文件智能生成符合要求的投标文件目录结构
- **正文生成**：调用工作流AI自动生成投标方案正文，支持一键生成全篇或按章节生成
- **附表生成**：调用工作流自动生成机械设备表、劳动力计划表、施工进度横道图等附表

**适用场景：** 适用于工程、货物、服务三大类型技术标书的快速生成
---
